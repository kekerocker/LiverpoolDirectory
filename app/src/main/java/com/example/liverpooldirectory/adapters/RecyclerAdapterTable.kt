...
class  RecyclerAdapterTable(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val itemGame: TextView = itemView.findViewById(R.id.tv_games)
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): RecyclerAdapterTable.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.table_layout,parent, false)
        return ViewHolder(v)
    }

    override fun onBindViewHolder(holder: RecyclerAdapterTable.ViewHolder, position: Int) {
